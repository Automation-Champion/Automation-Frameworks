...
/*		System.setProperty("webdriver.chrome.driver", "./DriverBrowser/chromedriver.exe");	
		...
		*/
             ...
             js.executeScript("document.getElementById('Email').value='seleniumbesttrainer@gmail.com'");
             js.executeScript("document.getElementById('next').click()");
             
             
             js.executeScript("window.scrollBy(0,150)", "");
            // WebElement element = (WebElement) js.executeScript("document.getElementById('table01');");
